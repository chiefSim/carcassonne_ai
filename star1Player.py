...
class Star1(Player):
    ...
    def __init__(self, currentPlayer = 0, Depth = 0, MaxDepth = 1, Alpha = -float('inf'), Beta = float('inf'), Chance = None):
        super().__init__()
    ...
    def chooseAction(self, state):
        ...
        if 'ExpectimaxStats.csv' in os.listdir('logs'):
            ...
            dfNew = {'Name': self.name,'MaxDepth':self.MaxDepth,'ProbingFactor':0,
